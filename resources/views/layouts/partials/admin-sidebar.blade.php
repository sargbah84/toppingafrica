        ...
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <li>
                ...
                <ul role="list" class="-mx-2 mt-2 space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.blog.content-lab') }}"
                           class="{{ request()->routeIs('admin.blog.content-lab*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }} group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="{{ route('admin.blog.calendar') }}"
                           class="{{ request()->routeIs('admin.blog.calendar') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }} group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <ul role="list" class="-mx-2 mt-2 space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.promotions.index') }}"
                           class="{{ request()->routeIs('admin.promotions.index') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }} group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            Promotions
                            @if($openPromotions = \App\Models\PromotionRequest::whereIn('status', ['inquiry', 'paid'])->count())
                                <span class="ml-auto rounded-full bg-indigo-600 px-2 py-0.5 text-xs text-white">{{ $openPromotions }}</span>
                            @endif
                        </a>
                    </li>
                </ul>
