...
<div>
    ...
    <div class="flex items-start gap-4 mb-8">
        ...
        <div>
            <h1 class="text-xl font-bold text-gray-900 dark:text-white">Reset your password</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Enter your new password below to regain access to your account.</p>
        </div>
    </div>
