<div>
    ...
    @php
        $dashboardTabs = [
            'overview' => ['Overview', 'M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0 1 18 16.5h-2.25m-7.5 0h7.5m-7.5 0-1 3m8.5-3 1 3m0 0 .5 1.5m-.5-1.5h-9.5m0 0-.5 1.5'],
            'traffic' => ['Traffic', 'M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z'],
            'search' => ['Search', 'M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z'],
            'tools' => ['Tools', 'M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.455 2.456L21.75 6l-1.036.259a3.375 3.375 0 00-2.455 2.456z'],
            'content' => ['Content', 'M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 0 1-2.25 2.25M16.5 7.5V18a2.25 2.25 0 0 0 2.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.25 0 0 0 2.25 2.25h13.5'],
            'growth' => ['Growth', 'M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941'],
            'engagement' => ['Engagement', 'M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.129.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 0 1 .865-.501 48.172 48.172 0 0 0 3.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z'],
            'settings' => ['Settings', 'M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.325.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 0 1 1.37.49l1.296 2.247a1.125 1.125 0 0 1-.26 1.431l-1.003.827c-.293.241-.438.613-.43.992a7.723 7.723 0 0 1 0 .255c-.008.378.137.75.43.991l1.004.827c.424.35.534.955.26 1.43l-1.298 2.247a1.125 1.125 0 0 1-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.47 6.47 0 0 1-.22.128c-.331.183-.581.495-.644.869l-.213 1.281c-.09.543-.56.94-1.11.94h-2.594c-.55 0-1.019-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 0 1-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 0 1-1.369-.49l-1.297-2.247a1.125 1.125 0 0 1 .26-1.431l1.004-.827c.292-.24.437-.613.43-.991a6.932 6.932 0 0 1 0-.255c.007-.38-.138-.751-.43-.992l-1.004-.827a1.125 1.125 0 0 1-.26-1.43l1.297-2.247a1.125 1.125 0 0 1 1.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.086.22-.128.332-.183.582-.495.644-.869l.214-1.28z M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0z'],
        ];
        $primaryTabs = array_slice($dashboardTabs, 0, 3, true);
        $overflowTabs = array_slice($dashboardTabs, 3, null, true);
        $overflowHasActive = array_key_exists($activeTab, $overflowTabs);
    @endphp

    <div class="flex items-center gap-1 mb-6 bg-white dark:bg-gray-800 rounded-xl shadow p-1.5">
        {{-- First 3 tabs: always visible --}}
        @foreach ($primaryTabs as $tab => [$label, $icon])
            <button
        ...
        {{-- Remaining tabs: inline on sm+, collapsed into dropdown on mobile --}}
        @foreach ($overflowTabs as $tab => [$label, $icon])
            <button
                wire:click="setTab('{{ $tab }}')"
                class="hidden sm:flex items-center gap-2 px-4 py-2.5 text-sm font-medium rounded-lg transition-colors
                    {{ $activeTab === $tab
                        ? 'bg-indigo-600 text-white shadow-sm'
                        : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700' }}"
            >
        ...
        {{-- Mobile-only "More" dropdown for the remaining tabs --}}
        <div class="relative sm:hidden ml-auto" x-data="{ open: false }" @click.outside="open = false" @keydown.escape.window="open = false">
            <button
                type="button"
                @click="open = !open"
            ...
            <div
                ...
                class="absolute right-0 top-full mt-1 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg ring-1 ring-black/5 dark:ring-white/10 py-1 z-30"
                role="menu"
            >
                @foreach ($overflowTabs as $tab => [$label, $icon])
                    <button
                        ...
                        @click="open = false"
                        role="menuitem"
                        class="w-full flex items-center gap-2 px-3 py-2 text-sm font-medium transition-colors
                            {{ $activeTab === $tab
...
GOOGLE_SEARCH_CONSOLE_SITE_URL=https://toppingafrica.com</pre>
    ...
    @elseif ($activeTab === 'engagement')
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:items-start">
            ...
            <div class="space-y-6">
                ...
                @php $qr = $this->qrCardShares; @endphp
                <div class="bg-white dark:bg-gray-800 shadow rounded-xl p-6">
                    <div class="flex items-center justify-between mb-4">
    ...
    {{-- Page Detail Modal --}}
    @php
        $pd = is_array($pageDetail ?? null) ? $pageDetail : null;
        $pdValid = $pd !== null
            && !empty($pd['title'])
            && !empty($pd['slug'])
            && !empty($pd['type']);
            ...
            <div class="flex items-start justify-center min-h-screen px-4 pt-16 pb-20">
                ...
                <div class="relative z-10 w-full max-w-2xl bg-white dark:bg-gray-800 rounded-xl shadow-2xl">
                    ...
                    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <div class="min-w-0 flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white truncate">{{ $pd['title'] ?? '' }}</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400 font-mono">/{{ $pd['slug'] ?? '' }}</p>
                        </div>
                    ...
                    <div class="px-6 py-5 space-y-5 max-h-[70vh] overflow-y-auto">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 text-center">
                                <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ number_format((int) ($pd['total_views'] ?? 0)) }}</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Page Views</p>
                            </div>
                            <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 text-center">
                                <p class="text-2xl font-bold text-indigo-600 dark:text-indigo-400">{{ number_format((int) ($pd['unique_visitors'] ?? 0)) }}</p>
                        ...
                        <div>
                            ...
                            <div class="flex items-end gap-1 h-20">
                                @php
                                    $dailyRaw = is_array($pd['daily'] ?? null) ? $pd['daily'] : [];
                                    $dailyViews = array_column($dailyRaw, 'views');
                                    $maxDaily = count($dailyViews) ? max(max($dailyViews), 1) : 1;
                                @endphp
                                @foreach ($dailyRaw as $day)
                                    @php $dayViews = (int) ($day['views'] ?? 0); $dayDate = (string) ($day['date'] ?? ''); @endphp
                                    <div class="flex-1 flex flex-col items-center gap-1">
                                        <span class="text-[10px] text-gray-500 dark:text-gray-400">{{ $dayViews }}</span>
                                        <div class="w-full bg-indigo-500 rounded-t" style="height: {{ max(($dayViews / $maxDaily) * 48, 2) }}px"></div>
                                        <span class="text-[9px] text-gray-400">{{ Str::substr($dayDate, 4) }}</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            @php $refs = is_array($pd['referrers'] ?? null) ? $pd['referrers'] : []; @endphp
                            @if (count($refs) > 0)
                                <div class="space-y-2">
                                    @foreach ($refs as $ref)
                                        <div class="flex items-center justify-between gap-2">
                                            ...
                                            <span class="text-sm font-semibold text-gray-900 dark:text-white flex-shrink-0">{{ number_format((int) ($ref['count'] ?? 0)) }}</span>
                                        </div>
                                    @endforeach
                                </div>
                            @else
                        ...
                        <div>
                            ...
                            @php $devices = is_array($pd['devices'] ?? null) ? $pd['devices'] : []; @endphp
                            @if (count($devices) > 0)
                                <div class="flex items-center gap-4">
                                    @php $totalDeviceViews = max(array_sum(array_column($devices, 'count')), 1); @endphp
                                    @foreach ($devices as $device)
                                        @php
                                            $devCount = (int) ($device['count'] ?? 0);
                                            $devType = $device['device_type'] ?? 'unknown';
                                            $pct = round(($devCount / $totalDeviceViews) * 100, 1);
                                        @endphp
                                        <div class="flex items-center gap-2">
                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {{ match($devType) { 'desktop' => 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400', 'mobile' => 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400', default => 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400' } }}">
                                                {{ ucfirst($devType) }}
                                            </span>
                                            <span class="text-sm text-gray-700 dark:text-gray-300">{{ $pct }}%</span>
                                            <span class="text-xs text-gray-400">({{ $devCount }})</span>
                                        </div>
                                    @endforeach
                                </div>
                            @else
                    ...
                    <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between">
                        <a href="{{ ($pd['type'] ?? '') === 'creator' ? '/creators/' . ($pd['slug'] ?? '') : '/' . ($pd['slug'] ?? '') }}" target="_blank" class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">View page &rarr;</a>
