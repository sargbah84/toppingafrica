    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        @if(count($selected) > 0)
            <div class="flex items-center gap-2">
                ...
                <button wire:click="bulkApprove" wire:confirm="Approve selected comments?"
                ...
                <button wire:click="bulkSpam" wire:confirm="Mark selected as spam?"
                ...
                <button wire:click="bulkDelete" wire:confirm="Delete selected comments? This cannot be undone."
