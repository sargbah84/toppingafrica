    ...
    <article class="max-w-container mx-auto px-4">
        ...
        <header class="max-w-3xl mx-auto pt-10 pb-8">
            @if($post->is_sponsored)
                <a href="{{ template_url('promote') }}" title="This is a paid promotion. Learn how to promote with Topping Africa."
                   class="inline-flex items-center gap-1.5 mb-4 px-2.5 py-1 rounded-full bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-300 text-xs font-bold uppercase tracking-wide hover:bg-amber-200 dark:hover:bg-amber-900/50 transition-colors">
