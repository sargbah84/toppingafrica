...
<section class="py-12 text-center">
    <a href="https://instagram.com/toppingafrica" target="_blank" rel="noopener" class="inline-flex items-center gap-2 text-primary hover:text-primary-hover transition-colors">
        ...
        <span class="text-sm font-semibold">toppingafrica</span>
    </a>
    <h3 class="text-2xl md:text-3xl font-black text-gray-900 dark:text-white mt-3">Follow Me On Instagram</h3>
    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Followed by: 2565</p>
</section>
            ...
            <div class="lg:w-[220px] flex-shrink-0">
                <div class="flex items-start gap-4 mb-5">
                    <div class="w-[100px] h-[120px] flex-shrink-0 overflow-hidden rounded-sm">
                        <img src="{{ asset('img/topping-africa-logomark.png') }}" alt="Topping Africa" class="w-full h-full object-cover">
                    </div>
                    <div class="pt-2">
                        <h4 class="text-white text-xl font-black leading-tight tracking-tight" style="font-family: Georgia, serif;">Topping Africa</h4>
                        <p class="text-xs text-primary italic mt-1">Creative Magazine</p>
                    </div>
                </div>
