<x-layouts.admin title="Create Ad" header="Create Ad">
    <div class="max-w-2xl">
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
            <form method="POST" action="{{ route('admin.ads.store') }}" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <select name="position" id="position" required
                        ...
                        <option value="in_article" {{ old('position') === 'in_article' ? 'selected' : '' }}>In Article</option>
                        <option value="after_content" {{ old('position') === 'after_content' ? 'selected' : '' }}>After Content</option>
                ...
                <div>
                    ...
                    <textarea name="code" id="code" rows="6"
                              ...
                              placeholder="Paste your AdSense code or custom HTML here...">{{ old('code') }}</textarea>
